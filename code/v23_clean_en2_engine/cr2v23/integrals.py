...
def build_cr2_cas12_integrals(
    ...
    eri = ao2mo.kernel(mol, mo[:, active_slice], compact=False).reshape(ncas, ncas, ncas, ncas)
    ...
    meta = {
        "schema": "cr2v23_active_integrals_v1",
        "atom": atom,
        "basis": basis,
        "spin": spin,
        "ncas": ncas,
        ...
        "active_rotation_shape": rotation_shape,
        "wall_seconds": time.time() - t0,
        "note": "v23 uses active-space integrals and PySCF direct_spin1; no JW Pauli cache.",
    }
